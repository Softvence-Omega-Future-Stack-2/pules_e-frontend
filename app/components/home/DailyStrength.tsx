...
const DailyStrength: React.FC = () => {
  return (
    <section className="bg-[#0a192f] py-24 px-6 flex flex-col items-center">
      ...
      <h2 className="text-[#C9A96E] font-lora text-2xl md:text-3xl font-bold mb-8 text-center">
      ...
      <div className="w-full max-w-4xl border border-[#C9A96E4D] rounded-2xl p-8">
        ...
        >
          <p className="text-white font-lora text-xl md:text-3xl  italic leading-relaxed md:leading-10">
        ...
        <div className="text-center mt-8">
          <cite className="text-[#C9A96E] font-lora font-semibold text-lg md:text-xl not-italic block">
            — Joshua 1:9
          </cite>

          <span className="text-[#F8F1E9B2] font-lora text-sm font-normal  tracking-widest mt-2 block">
