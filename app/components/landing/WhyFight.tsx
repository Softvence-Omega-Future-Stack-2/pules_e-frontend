    ...
    <section className=" py-20 ">
      <div className=" flex flex-col lg:flex-row items-center gap-12 xl:gap-24">
        ...
        <div className="w-full lg:w-1/2 relative">
          ...
          {/* Subtle glow effect behind image to match the "energy" theme */}
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
          ...
          <div className="space-y-6 text-[#374151] text-base md:text-lg font-normal leading-relaxed leading-6 md:leading-7 max-w-xl">
            <p>
             Current femtech tracks and reports—but we fight back. Our hyper-personalized tool covers hormonal health, fertility, Vitality Rebellion, Movement as Medicine, menopause, mental health, and more.
            </p>
